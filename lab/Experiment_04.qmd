...
filter types are shown in @fig-lab-04-tfs, where	$f_0 = \frac{1}{2 \pi RC} and $H_0$ is the low frequency gain of the
...
![Filter Transfer Functions](../images/lab-04-tfs){#fig-lab-04-tfs}
