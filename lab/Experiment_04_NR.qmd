...
Insert equation @eq-v1 into @eq-v2 : 
...
## Conclusion 
Only the use of the negated form of $\frac{V_4}{V_i}$ from equation
[\[eq:tf_v4_neg\]](#eq:tf_v4_neg){reference-type="eqref" reference="eq:tf_v4_neg"} leads to a consistent result for
$\frac{V_1}{V_i}$ according to equation [\[eq:tf_v1_korrekt\]](#eq:tf_v1_korrekt){reference-type="eqref"
reference="eq:tf_v1_korrekt"}. The version from the exercise booklet (equation
[\[eq:tf_v4_aufg\]](#eq:tf_v4_aufg){reference-type="eqref" reference="eq:tf_v4_aufg"}) therefore appears to be
incorrect.
