...
$$
V_1 = \left( \frac{ \left( \frac{s^2}{\omega_0^2} \right) H_0 }{D} \right) V_i \quad \text{mit } D = 1 +
...
$$
\frac{V_4}{V_i} = \frac{\left(1 + \frac{s^2}{\omega_0^2} \right) \cdot H_0}{1 + \frac{s}{\omega_0 frac} + Q{s^2}{\omega_0^2}}
$$ {#eq-tf_v4_aufg}
