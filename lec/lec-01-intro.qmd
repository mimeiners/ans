...
![](../images/lec-01-views_on_hardware_1.png)


## Ansichten zur Hardware (II)

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-views_on_hardware_2.png)


## Abstraktionsebenen

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-abstraction_layer.png)


## Entwurfsablauf

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-design_flow.png)


## Verifikation

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-verification.png)


### Frontend vs. Backend (analog)

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-front-end_back-end_analog.png)


## Frontend vs. Backend (digital)

![<p><em>(c) M. Ortmanns, Univ. Ulm.</em></p>](../images/lec-01-front-end_back-end_digital.png)
